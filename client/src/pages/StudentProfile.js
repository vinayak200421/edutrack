// Renders the detailed student profile view with animated entry.
import React from "react";
import { useSpring, animated } from "react-spring";

// Displays a student's full details; receives student and handleBack, returns the profile modal.
const StudentDetailsPage = ({ student, handleBack }) => {
  ...
  return (
    <animated.div
      style={animation}
      className='modal-overlay fixed inset-0 flex justify-center items-center bg-opacity-75 bg-gray-900'
    >
